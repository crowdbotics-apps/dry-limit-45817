"""
Django settings for dry_limit_45817 project.
...
ROOT_URLCONF = 'dry_limit_45817.urls'
...
WSGI_APPLICATION = 'dry_limit_45817.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_limit_45817 API",
    "DESCRIPTION": "API documentation for dry_limit_45817 App",
    "VERSION": "v1",
}
